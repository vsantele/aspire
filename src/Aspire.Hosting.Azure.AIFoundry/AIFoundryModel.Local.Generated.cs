...
public partial class AIFoundryModel
{
    ...
    public static class Local
    {
        ...
        /// <summary>
        /// This model is an optimized version of Mistral-7B-Instruct-v0.2 to enable local inference on TensorRT-RTX GPUs. # Model Description - **Developed by:** Microsoft - **Model type:** ONNX - **License:** apache-2.0 - **Model Description:** This is a conversion of the Mistral-7B-Instruct-v0.2 for local inference on TensorRT-RTX GPUs. - **Disclaimer:** Model is only an optimization of the base model, any risk associated with the model is the responsibility of the user of the model. Please verify and test for your scenarios. There may be a slight difference in output from the base model with the optimizations applied. Note that optimizations applied are distinct from fine tuning and thus do not alter the intended uses or capabilities of the model. # Base Model Information See Hugging Face model [Mistral-7B-Instruct-v0.2](https://huggingface.co/mistralai/Mistral-7B-Instruct-v0.2) for details.
        /// </summary>
        public static readonly AIFoundryModel MistralaiMistral7bInstructV02 = new() { Name = "mistralai-mistral-7b-instruct-v0.2", Version = "1", Format = "Microsoft" };
        ...
        /// </summary>
        public static readonly AIFoundryModel Phi4Mini = new() { Name = "phi-4-mini", Version = "4", Format = "Microsoft" };
        ...
        /// </summary>
        public static readonly AIFoundryModel Qwen2505b = new() { Name = "qwen2.5-0.5b", Version = "3", Format = "Microsoft" };
        ...
        /// </summary>
        public static readonly AIFoundryModel Qwen2514b = new() { Name = "qwen2.5-14b", Version = "3", Format = "Microsoft" };
        ...
        /// </summary>
        public static readonly AIFoundryModel Qwen257b = new() { Name = "qwen2.5-7b", Version = "3", Format = "Microsoft" };
        ...
        /// </summary>
        public static readonly AIFoundryModel Qwen25Coder05b = new() { Name = "qwen2.5-coder-0.5b", Version = "3", Format = "Microsoft" };
        ...
        /// </summary>
        public static readonly AIFoundryModel Qwen25Coder15b = new() { Name = "qwen2.5-coder-1.5b", Version = "3", Format = "Microsoft" };
        ...
        /// </summary>
        public static readonly AIFoundryModel Qwen25Coder14b = new() { Name = "qwen2.5-coder-14b", Version = "3", Format = "Microsoft" };
        ...
        /// </summary>
        public static readonly AIFoundryModel Qwen25Coder7b = new() { Name = "qwen2.5-coder-7b", Version = "3", Format = "Microsoft" };
    }
}
