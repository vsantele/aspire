...
internal static class AIHelpers
{
    ...
    internal static string GetResponseGraphJson(IEnumerable<ResourceViewModel> resources)
    {
        ...
        static List<object> GetResourceRelationships(IEnumerable<ResourceViewModel> allResources, ResourceViewModel resourceViewModel)
        {
